  ...
  return (
    <div id="home" className="flex items-center justify-evenly p-8 md:p-20 h-screen">
      ...
      <div className="hero-text max-h-screen w-full md:w-[50%] p-8 relative z-10 mt-8 text-left">
        <ScrollAnimation animateIn="animate__fadeInUp" delay={200} animateOnce={false}>
        ...
        <ScrollAnimation animateIn="animate__fadeInUp" delay={1000} animateOnce={false}>
      ...
      <div className="hero-image relative z-10 h-screen  ml-4 hidden md:inline-block">
