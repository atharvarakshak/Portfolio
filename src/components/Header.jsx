...
const Header = () => {
  ...
  return (
      ...
      <div className={ 
          !navState
            ? "absolute top-7 left-0 right-0 opacity-100 z-30 flex justify-between px-7 md:px-8 "
            : "fixed top-0 left-0 right-0 h-[9vh] flex items-center justify-between  opacity-100 z-[200] blur-effect-theme "
        }>
        {/* Logo section */}
        ...
        <div
          ...
          style={{ zIndex: 100 }}
        >
          {open ? <div className='flex-col'>  <XMarkIcon />  <ThemeChanger/> </div>:<div className='flex-col  '> <Bars3BottomRightIcon /> <ThemeChanger/> </div>}
        </div>
        {/* Link items */}
        <ul
