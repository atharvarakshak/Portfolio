  ...
  return (
    <section id="about" className="mt-28 grid grid-cols-1 md:grid-cols-2 gap-8 px-4">
      <div className="flex flex-col dark:text-white ">
        ...
        <ScrollAnimation animateIn="fadeInLeft" delay={100} duration={1.5}>
        ...
        <ScrollAnimation animateIn="fadeInLeft" delay={200} duration={1.5} className="my-8">
          <p className="text-lg font-medium tracking-wide">
        ...
        <ScrollAnimation animateIn="fadeInLeft" delay={300} duration={1.5}>
          <p className="text-lg font-medium tracking-wide">
        ...
        <ScrollAnimation animateIn="fadeInLeft" delay={400} duration={1.5}>
        ...
        <div className="hard-skills flex flex-wrap items-center gap-7 mt-6">
          {[
            { src: wordpress, alt: 'WordPress', delay: 100 },
            { src: shopify, alt: 'Shopify', delay: 120 },
            ...
            <div className="hability flex flex-col items-center" key={index}>
              <ScrollAnimation animateIn="fadeInUp" delay={skill.delay} duration={1.5}>
      ...
      <div className="about-image text-center">
        <ScrollAnimation animateIn="fadeInRight" delay={400} duration={1.8}>
